...
## Role Overview
We're on the hunt for a skilled GIS Specialist and Cartographer with a passion for data architecture and cartography. This role is perfect for someone with a keen eye for detail, a love for maps, and a knack for turning complex datasets into compelling visual stories using ArcGIS software and R programming. If you have a bachelor's degree or higher qualification with over two years of experience in the field, we'd love to hear from you!

## Key Responsibilities
- Design and implement comprehensive surveys and data collection strategies.
- Compile and evaluate data, interpret codes of practice, and write reports concerning survey measurement, land use, and tenure.
- Develop and apply advanced statistical and choice modeling techniques.
- Evaluate, compile, and maintain spatial information using a range of digital and graphical source materials such as survey documents, existing maps and records, historical data, reports, and statistics.
- Conduct spatial analysis and create detailed maps using GIS technology, particularly ArcGIS.
- Visualise data in innovative and accessible ways for diverse audiences.
- Analyse and interpret data to design maps, graphs, plans, drawings, and three-dimensional models using geographic information and related systems.
- Develop and trial new applications for use in geographic information systems and GIS apps.
- Collaborate on research and consulting projects, contributing both data analysis and cartographic expertise.
- Stay abreast of the latest developments in GIS, data analysis, and visualisation techniques.

## Requirements
- Bachelor's degree or higher qualification in Geography, Spatial Sciences, Architecture, Data Science, or a related field.
- A minimum of 2 years of professional experience in data analysis, GIS, cartography, and/or 3D modeling.
...
## How to Apply
Please send your resume, a cover letter explaining why you're the perfect fit for this role, and any relevant work samples to enlightened.data@gmail.com. We're looking forward to getting to know you and exploring how your skills and passions align with our mission at Enlightened Data.
