...
How could modellers estimate the amount of money that **people are collectively willing to spend to reduce road cashes** and **the chance of involving in a certain type of road crash** such as fatal or major injury that requires hospitalisation? Economists terms these concepts as a **Willingness To Pay** (WTP) value and a **crash probability**. These are the two vital inputs for the estimation of the VSL. 

What do we need to do the get these values? Two things, really. High quality data and good behavioural models. 
